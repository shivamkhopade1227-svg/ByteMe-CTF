...
# Import split private key component from Dragonstone
from dragonstone import _PART_B

# Local split component
_PART_A = int.from_bytes(b"targaryen_", "big")

# Reconstruct static server private key (not stored in one place)
...
# Misleading constant (not actually used)
NONCE_SIZE = 16
...
# -------------------------------------------------------------------
# Static challenge – no direct execution
# -------------------------------------------------------------------
